                        ...
                        <ul class="submenu">
                            ...
                            <form method="post" class="form-horizontal" action="/user/profile/meta/store">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="control-label col-md-1 tab-con"><?php echo e(trans('main.fichier_info')); ?></label>
                                    <div class="col-md-5 tab-con">
                                        <input type="text" name="fichier" value="<?php echo e(!empty($meta['fichier']) ? $meta['ficher'] : ''); ?>" class="form-control">
                                    </div>
...
<?php echo $__env->make(getTemplate() . '.user.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\proacademy-site\resources\views/web/default/user/pages/profile.blade.php ENDPATH**/ ?>