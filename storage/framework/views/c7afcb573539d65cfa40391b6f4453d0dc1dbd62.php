                        ...
                        <?php if($content->content->mode == 'publish'): ?>
                            ...
                            <div class="owl-car-s" dir="rtl">
                                <a href="/product/<?php echo e($popular->id); ?>/<?php echo \Illuminate\Support\Str::slug($popular->title) ?? '-'; ?>" title="<?php echo e($popular->title); ?>" class="content-box">
                                    ...
                                    <div class="footer">
                                        <span class="avatar" title="<?php echo e(isset($popular->user->name)?? $popular->user->name); ?>" onclick="window.location.href = '/profile/<?php echo e(isset($popular->user->id) ?? $popular->user->id); ?>'"><img src="<?php echo e(get_user_meta(isset($popular->user->id) ?? $popular->user->id,'avatar',get_option('default_user_avatar',''))); ?>"></span>
...
<?php /**PATH C:\laragon\www\proacademy-site\resources\views/web/default/view/parts/vip.blade.php ENDPATH**/ ?>