...
<?php echo $__env->make($user['vendor'] == 1 ? getTemplate() . '.user.layout.requestVideoLayout' : getTemplate() . '.user.layout_user.requestlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\proacademy-site\resources\views/web/default/user/request/request.blade.php ENDPATH**/ ?>