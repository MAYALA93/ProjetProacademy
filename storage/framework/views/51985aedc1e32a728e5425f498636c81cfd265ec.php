    ...
    <script>
        $('.regTag').click(function () {
            if ($('.regTag strong').text() == 'Register') {
                $('.regTag strong').text('Inscription');
                $('.regTag strong').css('position', 'static');
            } else {
                $('.regTag strong').text('Connexion');
...
<?php echo $__env->make(getTemplate().'.view.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\proacademy-site\resources\views/web/default/auth/login.blade.php ENDPATH**/ ?>