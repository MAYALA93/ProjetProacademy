                        ...
                        <ul class="submenu">
                            ...
                            <form method="post" class="form-horizontal" action="/user/profile/meta/store">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="control-label col-md-1 tab-con">{{ trans('main.fichier_info') }}</label>
                                    <div class="col-md-5 tab-con">
                                        <input type="text" name="fichier" value="{{ !empty($meta['fichier']) ? $meta['ficher'] : '' }}" class="form-control">
                                    </div>
